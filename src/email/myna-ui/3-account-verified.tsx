...
export default function MynaUIAcountVerifiedEmail() {
  return (
    <Html>
      <Head />
      <Preview>Myna UI - Account Verified</Preview>
      <Tailwind
        config={{
          darkMode: "class",
          theme: {
                  ...
                  <td>
                    ...
                    <Section>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-6 p-0 text-base">
                        Success! Your email has been verified. You&apos;re now all set to explore
                        the vast world of MynaUI.
                      </Text>
                    </Section>

                    <Section>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        Start saving and organizing your favorite web content, and discover what
                        others are bookmarking in the MynaUI community.
                      </Text>
                    </Section>

                    <Section className="mt-4">
                      <Text className="text-text-light dark:text-text-dark m-0 p-0 text-base">
                        If you have any questions or need a hand getting started, contact us at
                        help@mynaui.com.
                      </Text>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        Enjoy your journey with MynaUI!
                      </Text>
                    </Section>
                  </td>
                </tr>
