...
export default function MynaUIPasswordUpdatedEmail() {
  return (
    <Html>
      <Head />
      <Preview>Myna UI - Password Updated</Preview>
      <Tailwind
        config={{
          darkMode: "class",
          theme: {
                ...
                <tr>
                  <td>
                    ...
                    <Section>
                      ...
                      <Text className="text-text-light dark:text-text-dark m-0 mt-2 p-0 text-base">
                        Your MynaUI password has been changed successfully. If you did not initiate
                        this change, please contact us immediately to ensure the security of your
                        account.
                      </Text>
                    </Section>
                    ...
                    <Section>
                      <Text className="text-text-light dark:text-text-dark m-0 p-0 text-base">
                        Here are some <strong>tips</strong> for creating a strong password:
                      </Text>

                      <ul className="mt-2 list-disc pl-4">
                        <li className="text-text-light dark:text-text-dark text-[15px] leading-6">
