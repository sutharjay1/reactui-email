                  ...
                  <td>
                    ...
                    <Section>
                      <Text className="text-text-light dark:text-text-dark text-base">
                        We&apos;re thrilled to have you on board at MynaUI, the ultimate destination
                        for your bookmarking needs. Before you dive into organizing and accessing
                        your favorite web content with ease, there&apos;s just one small step left -
                        verifying your email.
                      </Text>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        Click the link below to confirm your email address and unlock a world of
                        bookmarking possibilities.
                      </Text>
                    </Section>
                    ...
                    <Section className="mt-4">
                      <Text className="text-text-light dark:text-text-dark m-0 p-0 text-base">
                        If you have any questions, our support team is just an email away. Welcome
                        to the MynaUI community!
                      </Text>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        Happy Bookmarking, The MynaUI Team
                      </Text>
                    </Section>
                  </td>
                </tr>
