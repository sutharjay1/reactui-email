...
export default function MynaUIAcountLockedEmail() {
  return (
    <Html>
      <Head />
      <Preview>Myna UI - Account Locked</Preview>
      <Tailwind
        config={{
          darkMode: "class",
          theme: {
                  ...
                  <td>
                    ...
                    <Section>
                      ...
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        For your security, we&apos;ve temporarily locked your MynaUI account after
                    ...
                    <Section>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        To unlock your account and create a new password, please click the link
                        below:
                      </Text>
                    </Section>
                          ...
                          <td>
                            ...
                            >
                              <Row className="m-0 p-0">
                                <Column className="text-white">Unlock My Account</Column>
                                <Column>
                                  <svg
                                    width="24"
                                    height="24"
                    ...
                    <Section className="mt-4">
                      <Text className="text-text-light dark:text-text-dark m-0 p-0 text-base">
                        This measure is to ensure that only you have access to your account. If you
                        have any concerns or if you did not attempt these logins, please ignore this
                        email.
                      </Text>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        Stay safe,
