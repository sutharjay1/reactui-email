...
export default function MynaUILoginAlertEmail() {
  return (
    <Html>
      <Head />
      <Preview>Myna UI - Login Alert</Preview>
      <Tailwind
        config={{
          darkMode: "class",
          theme: {
                  ...
                  <td>
                          ...
                          <td className="h-[40px] w-[40px] rounded-[8px]">
                            ...
                            >
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                              >
                                <path d="M16.286 3H7.714C6.768 3 6 3.806 6 4.8v14.4c0 .994.768 1.8 1.714 1.8h8.572c.947 0 1.714-.806 1.714-1.8V4.8c0-.994-.767-1.8-1.714-1.8M10.5 6h3" />
                              </svg>
                            </Section>
                          </td>
                    ...
                    <Section>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-6 p-0 text-base">
                        We noticed a new device trying to access your MynaUI account. Security is a
                        top priority for us, so double check the information below!
                      </Text>
                    </Section>
                      ...
                      >
                        <tr>
                          ...
                          >
                            ...
                            <Text className="text-text-light dark:text-text-dark m-0 p-0 text-base">
                              <strong>Apple iPhone 15 - iOS 19</strong>
                            </Text>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          >
                            ...
                            <Text className="text-text-light dark:text-text-dark m-0 p-0 text-base">
                              <strong>12:04 PM - 18 Dec 2024</strong>
                            </Text>
                          </td>
                        </tr>
                      </table>
