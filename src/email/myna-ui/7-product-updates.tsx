                  ...
                  <td>
                          ...
                          <td className="h-[40px] w-[40px] rounded-[8px]">
                            ...
                            >
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                              >
                                <path d="M9.5 12V8h3.671c2.192 0 2.5 3.258.456 4M9.5 12v4h3.671c2.192 0 2.5-3.258.456-4M9.5 12h4.127" />
                    ...
                    <Section>
                      ...
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        ...
                        access to our beta features! To join and start testing these exciting new
                        additions, please verify your email:
                      </Text>
                    </Section>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <Text className="text-text-light dark:text-text-dark m-0 p-0 text-center text-base">
                                Provide direct feedback to shape MynaUI&apos;s future.
                              </Text>
                            </td>
                            ...
                            >
                              <Section
                                ...
                                style={{
                                  ...
                                  borderRadius: "12px",
                                  border: "1px solid hsl(0 93.3% 94.1%)",
                                }}
                              >
                                <svg
                                  width="32"
                                  ...
                                  strokeWidth="2"
                                  className="text-[hsl(0 84.2% 60.2%)]"
                                  viewBox="0 0 24 24"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                  xmlns="http://www.w3.org/2000/svg"
                                >
                                  <path d="M9.5 10.5V10m5 .5V10M9 15c.85.63 1.885 1 3 1s2.15-.37 3-1" />
                                  <path d="M3 9.4c0-2.24 0-3.36.436-4.216a4 4 0 0 1 1.748-1.748C6.04 3 7.16 3 9.4 3h5.2c2.24 0 3.36 0 4.216.436a4 4 0 0 1 1.748 1.748C21 6.04 21 7.16 21 9.4v5.2c0 2.24 0 3.36-.436 4.216a4 4 0 0 1-1.748 1.748C17.96 21 16.84 21 14.6 21H9.4c-2.24 0-3.36 0-4.216-.436a4 4 0 0 1-1.748-1.748C3 17.96 3 16.84 3 14.6z" />
                                </svg>
                              </Section>
                              <Text className="text-text-light dark:text-text-dark m-0 p-0 text-center text-base">
                                Enjoy a sneak peek into our innovation process.
                              </Text>
                            </td>
                          </tr>
                        </table>
                          ...
                          <td>
                            ...
                            >
                              <Row className="m-0 p-0">
                                <Column className="text-white">Join Beta Testing</Column>
                                <Column>
                                  <svg
                                    width="24"
                                    height="24"
                    ...
                    <Section className="mt-4">
                      <Text className="text-text-light dark:text-text-dark m-0 p-0 text-base">
                        Ready to be a part of our beta community?
                      </Text>
                      <Text className="text-text-light dark:text-text-dark m-0 mt-4 p-0 text-base">
                        Best,
                      </Text>
